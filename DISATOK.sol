...
contract Disatok is Ownable, IERC20, IERC20Metadata {
    ...
    constructor() {
        ...
        _feeExcludes[address(this)] = true;
...
*/
    ...
    function _transfer(
        ...
        if(noFee){
            ...
            uint fee = _calculateTaxFee(amount);
            uint senderAmount = amount + fee;
            ...
            emit Transfer(msg.sender, _accountFee, fee);
...
/*
        ...
        if(noFee){
            ...
            _balances[_accountFee] += fee;
            _balances[recipient] += rest;
            
            emit Transfer(msg.sender, _accountFee, fee);
            emit Transfer(msg.sender, recipient, rest);            
        }
*/
...
*/
    ...
    function addNewSupply(uint256 amount) public onlyOwner returns (uint256) {
        ...
        uint newSupply = amount * 10**_decimals;
